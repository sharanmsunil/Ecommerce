        ...
        appBar: AppBar(
          actions: [
            IconButton(onPressed: (){
              Navigator.of(context).push(MaterialPageRoute(builder: (context)=>Cart_Page(data: allshoes(image: widget.data.image, name: widget.data.name, desc: widget.data.desc, price: widget.data.price))));
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(widget.data.name,style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 15),),
              ),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20,vertical: 5),
                child: Text('\$${widget.data.price}',style: TextStyle(color: Colors.black),),
              ),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20,vertical: 5),
                child: Row(
              ...
              Row(
                ...
                children: [
                  ElevatedButton(
                      ...
                      onPressed: (){
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Center(child: Text("Added to Bag",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 10),)),backgroundColor: Colors.white,));
        ...
        children: _details.map<ExpansionPanel>((Detail details) {
          return ExpansionPanel(
            headerBuilder: (BuildContext context, bool isExpanded) {
              return ListTile(
                title: Text(details.title,style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 15),),
              );
            },
            body: ListTile(
              title: Text(details.body,style: TextStyle(color: Colors.grey,fontSize: 12),),
            ),
